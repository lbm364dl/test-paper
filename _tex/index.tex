...
\phantomsection\label{cell-fig-line-plot}
\begin{figure}[H]

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-line-plot-1.pdf}}
...
You can reference the above Figure~\ref{fig-line-plot}.
